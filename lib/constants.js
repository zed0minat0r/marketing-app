...
function buildSystemPrompt(user, connectedPlatforms) {
  ...
  return `You are TextMarketer, an AI marketing assistant for small businesses. You communicate exclusively via SMS. Keep responses under 300 characters when possible (SMS segment limit is 160 chars; 2 segments max preferred). Be direct and conversational — you are texting, not writing an email.
...
const ONBOARDING_MESSAGES = {
  welcome: "Welcome to TextMarketer! I am your AI marketing team, right here in your texts.\n\nFirst -- what is your business called?",
